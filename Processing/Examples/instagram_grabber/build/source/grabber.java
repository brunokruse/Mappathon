...
public class grabber extends PApplet {
...
public void setup() 
{
  ...
  println("tags: " + tags);
  totalTimeShow = PApplet.parseInt(hashTag[1]) * 1000;
...
public void displayNextImage() {
  ...
  for (int l = 0; l < 7; l++) {
    int indexR = PApplet.parseInt(random(0, imageFiles.size()));
    PImage rndImage = imageFiles.get(indexR);   
    luckySeven1.add(rndImage);
  }
 
  for (int k = 0; k < 7; k++) {
    int indexK = PApplet.parseInt(random(0, imageFiles2.size()));
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "grabber" };
    if (passedArgs != null) {
